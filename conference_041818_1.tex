...
\begin{figure*}[!t]
	\centering
	\subfigure[Small Workload ]{\label{Fig:instance1}\includegraphics[height=1.6in]{fig_instance1_8.eps}}\quad\quad %quad 表示图像的间距
	\subfigure[Medium Workload ]{\label{Fig:instance2}\includegraphics[height=1.6in]{fig_instance2_8.eps}}\quad\quad
	\subfigure[Large Workload
	]{\label{Fig:instance3}\includegraphics[height=1.6in]{fig_instance3_8.eps}}
	\vspace{-1ex}
...
\begin{figure*}[!t]
	\centering
	\subfigure[Results under various I/O workloads ]{\label{Fig:completeWorkload}\includegraphics[height=1.6in]{figcomplete1_7.eps}}\quad\quad %quad 表示图像的间距
	\subfigure[Results under various I/O performance]{\label{Fig:completeHeter}\includegraphics[height=1.6in]{figcomplete2_7.eps}}\quad\quad
	\subfigure[Results under various number of data replica
	]{\label{Fig:completeRep}\includegraphics[height=1.6in]{figcomplete3_7.eps}}
	\vspace{-1ex}
...
\begin{figure*}[!t]
	\centering
	\subfigure[Small Workload ]{\label{Fig:unbalance1}\includegraphics[height=1.6in]{fig_unbanlancedata1_1.eps}}\quad\quad %quad 表示图像的间距
	\subfigure[Medium Workload ]{\label{Fig:unbalance2}\includegraphics[height=1.6in]{fig_unbanlancedata2_1.eps}}\quad\quad
	\subfigure[Large Workload
	]{\label{Fig:unbalance3}\includegraphics[height=1.6in]{fig_unbanlancedata3_1.eps}}
	\vspace{-1ex}
