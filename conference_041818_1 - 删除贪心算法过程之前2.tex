...
The distribution of data can be obtained before tasks arrive, i.e., $\pi_{\phi_j}^{i}$ is known. But the traditional distributed file system, e.g., HDFS, doesn't provide the interface of changing data distribution. To avoid disk bottleneck, what we only could do is to make reasonable decision for arrived reading tasks to select target disks.
...
%In this subsection, 
%To avoid disks bottleneck by tasks to be scheduled, we design a randomized algorithm, named $r$WASH, which avoids disk bottleneck by choosing source devices based on delicate calculated probabilities. 
...
\begin{figure*}[!t]
	\centering
	\subfigure[Small Workload ]{\label{Fig:instance1}\includegraphics[height=1.55in]{fig_instance1_12.eps}}\quad\quad %quad 表示图像的间距
	\subfigure[Medium Workload ]{\label{Fig:instance2}\includegraphics[height=1.55in]{fig_instance2_12.eps}}\quad\quad
	\subfigure[Large Workload
	]{\label{Fig:instance3}\includegraphics[height=1.5in]{fig_instance3_12.eps}}
	\vspace{-1ex}
...
\begin{figure*}[!t]
	\centering
	\subfigure[Results under various I/O workloads ]{\label{Fig:completeWorkload}\includegraphics[height=1.6in]{figcomplete1_8.eps}}\quad\quad %quad 表示图像的间距
	\subfigure[Results under various I/O performance]{\label{Fig:completeHeter}\includegraphics[height=1.6in]{figcomplete2_8.eps}}\quad\quad
	\subfigure[Results under various number of data replica
	]{\label{Fig:completeRep}\includegraphics[height=1.6in]{figcomplete3_8.eps}}
	\vspace{-1ex}
...
\begin{figure*}[!t]
	\centering
	\subfigure[Small Workload ]{\label{Fig:unbalance1}\includegraphics[height=1.6in]{fig_unbanlancedata1_3.eps}}\quad\quad %quad 表示图像的间距
	\subfigure[Medium Workload ]{\label{Fig:unbalance2}\includegraphics[height=1.6in]{fig_unbanlancedata2_3.eps}}\quad\quad
	\subfigure[Large Workload
	]{\label{Fig:unbalance3}\includegraphics[height=1.6in]{fig_unbanlancedata3_3.eps}}
	\vspace{-1ex}
